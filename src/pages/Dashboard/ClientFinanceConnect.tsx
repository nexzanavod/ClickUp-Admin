...
export default function ClientFinanceConnectPage() {
  const clientName = "Finance Connect";
  const projectName = "Finance Connect Project";
  const teamId = import.meta.env.VITE_CLICKUP_TEAM_ID as string | undefined;
  const listId = import.meta.env.VITE_CLICKUP_FINANCE_LIST_ID as string | undefined;
  const clickUpUrl =
    teamId && listId
  ...
  return (
    <>
      <PageMeta
        title="Client Finance Connect Dashboard | TailAdmin"
        description="Client Finance Connect delivery sign-off dashboard"
      />
