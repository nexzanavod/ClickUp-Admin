...
export default function ClientPhillisPage() {
  const clientName = "Phillis Real Estate";
  const projectName = "Phillis Real Estate Project";
  const teamId = import.meta.env.VITE_CLICKUP_TEAM_ID as string | undefined;
  const listId = import.meta.env.VITE_CLICKUP_PHILLIS_LIST_ID as string | undefined;
  const clickUpUrl =
    teamId && listId
  ...
  return (
    <>
      <PageMeta
        title="Client Phillis Real Estate Dashboard | TailAdmin"
        description="Client Phillis Real Estate delivery sign-off dashboard"
      />
