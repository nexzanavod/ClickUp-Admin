...
export default function ClientEldersPage() {
  const clientName = "Benny Holder";
  const projectName = "Elders Real Estate";
  ...
  return (
    <>
      <PageMeta
        title="Elders Real Estate - Benny Holder Dashboard | TailAdmin"
        description="Elders Real Estate - Benny Holder delivery sign-off dashboard"
      />
