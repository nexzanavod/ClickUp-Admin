...
export default function ClientTweedCoastPage() {
  const clientName = "PRD Tweed Coast";
  const projectName = "PRD Tweed Coast Project";
  const teamId = import.meta.env.VITE_CLICKUP_TEAM_ID as string | undefined;
  const listId = import.meta.env.VITE_CLICKUP_TWEED_COAST_LIST_ID as string | undefined;
  const clickUpUrl =
    teamId && listId
  ...
  return (
    <>
      <PageMeta
        title="PRD Tweed Coast Dashboard | TailAdmin"
        description="PRD Tweed Coast delivery sign-off dashboard"
      />
