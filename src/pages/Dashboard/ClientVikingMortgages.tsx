...
export default function ClientVikingMortgagesPage() {
  const clientName = "Viking Mortgages";
  const projectName = "Viking Mortgages Project";
  const teamId = import.meta.env.VITE_CLICKUP_TEAM_ID as string | undefined;
  const listId = import.meta.env.VITE_CLICKUP_VIKING_LIST_ID as string | undefined;
  const clickUpUrl =
    teamId && listId
  ...
  return (
    <>
      <PageMeta
        title="Client Viking Mortgages Dashboard | TailAdmin"
        description="Client Viking Mortgages delivery sign-off dashboard"
      />
