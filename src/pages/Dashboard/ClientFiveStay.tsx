...
export default function ClientFiveStayPage() {
  const clientName = "Five Star Stays";
  const projectName = "Five Star Stays Project";
  const teamId = import.meta.env.VITE_CLICKUP_TEAM_ID as string | undefined;
  const listId = import.meta.env.VITE_CLICKUP_FIVESTAY_LIST_ID as string | undefined;
  const clickUpUrl =
    teamId && listId
  ...
  return (
    <>
      <PageMeta
        title="Client Five Star Stays Dashboard | TailAdmin"
        description="Client Five Star Stays delivery sign-off dashboard"
      />
