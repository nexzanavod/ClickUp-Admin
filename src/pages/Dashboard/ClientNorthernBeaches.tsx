...
export default function ClientNorthernBeachesPage() {
  const clientName = "PRD Northern Beaches";
  const projectName = "PRD Northern Beaches Project";
  const teamId = import.meta.env.VITE_CLICKUP_TEAM_ID as string | undefined;
  const listId = import.meta.env.VITE_CLICKUP_NORTHERN_BEACHES_LIST_ID as string | undefined;
  const clickUpUrl =
    teamId && listId
  ...
  return (
    <>
      <PageMeta
        title="PRD Northern Beaches Dashboard | TailAdmin"
        description="PRD Northern Beaches delivery sign-off dashboard"
      />
